...
<div id="badges">
  ...
  <a href="linkedin.com/in/сергей-краснопёров-1bba49343">
...
---
### :raising_hand_man: About Me : Меня зовут Сергей, и в настоящее время развиваю экспертные знания в области анализа и визуализации данных.
### :books: Additional education : Постоянно совершенствую свои навыки с помощью онлайн-курсов, книг и open-source проектов. Сосредоточен на том, чтобы быть в курсе последних тенденций в отрасли.
### :e-mail: Открыт к сотрудничеству и нетворкингу по электронной почте или в социальных сетях.
### :globe_with_meridians: совершенствую иностранные языки.
- Яндекс практикум:  `аналитик данных`, `основы статистики и А/B тестирования`, `DataLens: анализ и визуализация данных`.
- Stepik: `основы статистики`, `ClickHouse для аналитика`.
